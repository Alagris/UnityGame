...
TEXTURE2D_ARRAY(_DetailNormalMap);    SAMPLER(sampler_DetailNormalMap);
...
half3 ApplyDetailNormal(float2 detailUv, half3 normalTS, half detailMask)
{
    ...
    half3 detailNormalTS = UnpackNormal(SAMPLE_TEXTURE2D_ARRAY(_DetailNormalMap, sampler_DetailNormalMap, detailUv));
#else
    half3 detailNormalTS = UnpackNormalScale(SAMPLE_TEXTURE2D_ARRAY(_DetailNormalMap, sampler_DetailNormalMap, detailUv), _DetailNormalMapScale);
#endif
