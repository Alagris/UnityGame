#ifndef _INCLUDE_BLENDER_HLSL_
#define _INCLUDE_BLENDER_HLSL_
int float_as_uint(float f);

int hash(int kx);
int hash(int kx, int ky);
int hash(int kx, int ky, int kz);
int hash(int kx, int ky, int kz, int kw);

/* Hash floats to `int`. */

int hash_float(float kx);
int hash_float(float2 k);
int hash_float(float3 k);
int hash_float(float3 k);
int hash_float(float4 k);

/* Hash integers to `float` between 0 and 1. */

float hash_to_float(int kx);
float hash_to_float(int kx, int ky);
float hash_to_float(int kx, int ky, int kz);
float hash_to_float(int kx, int ky, int kz, int kw);
